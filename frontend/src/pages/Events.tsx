...
const mockEvents = [
  {
    ...
    description: "Build the next generation of AI applications that solve real-world problems. Open to all skill levels.",
...
const Events = () => {
  ...
  const filteredEvents = mockEvents.filter((event) => {
    ...
    const matchesCategory = selectedCategory === "all" || event.tags.some(tag => 
        ...
        <div className="container">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Join thousands of developers, designers, and innovators in exciting hackathons and competitions.
            </p>
          </div>
        </div>
      </section>
